...
element = driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[10]/div[2]/a[9]")
driver.execute_script("arguments[0].click();", element)
#线上
#driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[15]").click()
#driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[15]/div[2]/a[6]").click()
#添加
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[1]/div/div[1]/div/a/button").click()
time.sleep(2)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[1]/div/div/div").click()
time.sleep(2)
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[2]/div/div/input").send_keys("18770295955")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[1]/div/input").send_keys("我的宝贝")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[2]/div/div/div[1]/input").send_keys("D:/cat.jpg")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[3]/div/input").send_keys("1000")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[4]/div/input").send_keys("元/个")
time.sleep(2)
...
time.sleep(2)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[2]/div/div/table/tbody/tr[2]/td/a").click()
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr[1]/td[1]/div/input").send_keys("1")
capture(driver,filephoto="D:/"+str(time.time)+".png")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/button[2]").click()
#搜索
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[1]/div/div[2]/div/span/span/input").send_keys("户主")
