...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/input").send_keys("危房改造")
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[2]/div/div[1]/i").click()
time.sleep(1)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[2]/div/div[@class='el-select-dropdown']/div/div[1]/ul/li[1]").click()
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[3]/div/input").send_keys("1500")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[4]/div/input").send_keys("备注")
