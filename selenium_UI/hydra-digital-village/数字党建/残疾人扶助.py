...
time.sleep(1)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[2]/a[5]").click()
#添加
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/input").send_keys("残疾人帮扶")
