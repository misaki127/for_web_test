...
time.sleep(1)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[2]/a[4]").click()
#添加
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/input").send_keys("留守儿童")
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[4]/div/div[1]/i").click()
time.sleep(1)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[4]/div/div[2]/div/div[1]/ul[@class='el-scrollbar__view el-select-dropdown__list']/li[2]").click()
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[5]/div/div").click()
time.sleep(1)
ele_list = driver.find_elements_by_tag_name('li')
for i in ele_list:
    if i.text == '本科':
        i.click()
    else:
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[6]/div/input").send_keys("监护人")
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[4]/div/div/div/div/div/div/div/div[1]/div/table/tbody/tr/td[7]/div/input").send_keys("关系")
