...
time.sleep(1)
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[2]/a[6]").click()
#添加
...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/form/div[3]/div/div/input").send_keys("残疾人扶助")
...
time.sleep(2)
driver.find_element_by_xpath("//*[@class='ant-select-dropdown ant-select-dropdown--single ant-select-dropdown-placement-bottomLeft']/div/ul/li[7]").click()
