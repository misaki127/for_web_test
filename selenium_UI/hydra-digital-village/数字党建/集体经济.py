...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[7]/div[2]/a[2]").click()
#线上
#driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[13]").click()
#driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[13]/div[2]/a[2]").click()
#添加
...
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[2]/div/div/input").send_keys("测试合作社")
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[3]/div/div/input").send_keys("123456789012345678")
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[4]/div/div/input").send_keys("王测测")
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[5]/div/div/div/div[1]/input").send_keys("D:/cat.jpg")
time.sleep(3)
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[6]/div/div/span/div/i").click()
time.sleep(2)
driver.find_element_by_xpath("/html/body/div[4]/div/div/div/div[2]/table[@class='el-date-table']/tbody/tr[3]/td[4]").click()
...
#查看
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[7]/div/div/a[1]").click()
capture(driver,filephoto="D:/" + str(time.time())+".png")
driver.find_element_by_xpath("/html/body/div[4]/div/div[2]/div/div[2]/button").click()
#编辑
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[7]/div/div/a[2]").click()
time.sleep(2)
...
driver.refresh()
#删除
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[7]/div/div/a[3]").click()
