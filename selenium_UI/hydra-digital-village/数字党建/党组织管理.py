...
time.sleep(1)
#点击党组织管理
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[10]/div[2]/a[1]").click()#测试
...
time.sleep(3)
driver.find_element_by_css_selector("body > div:nth-child(17) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > form > div:nth-child(1) > div > div > input").send_keys("4")#党支部
driver.find_element_by_css_selector("body > div:nth-child(17) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > form > div:nth-child(2) > div > div > div > div").click()#点击姓名
time.sleep(2)
driver.find_element_by_xpath("//*[@class='ant-select-dropdown ant-select-dropdown--single ant-select-dropdown-placement-bottomLeft']/div/ul/li[5]").click()
driver.find_element_by_css_selector("body > div:nth-child(17) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > form > div:nth-child(4) > div > div > span > div").click()#日历
time.sleep(2)
driver.find_element_by_xpath("/html/body/div[5]/div/div/div/div[2]/table[@class='el-date-table']/tbody/tr[3]/td[5]").click()
time.sleep(1)
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[3]/div/button[2]").click()#确定
...
driver.find_element_by_css_selector("body > div:nth-child(19) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > form > div:nth-child(1) > div > div > input").clear()
driver.find_element_by_css_selector("body > div:nth-child(19) > div > div.ant-modal-wrap > div > div.ant-modal-content > div.ant-modal-body > form > div:nth-child(1) > div > div > input").send_keys("04")
driver.find_element_by_xpath("/html/body/div[4]/div/div[2]/div/div[2]/div[3]/div/button[2]").click()
capture(driver,filephoto="D:/"+str(time.time)+".png")
#搜索
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[1]/div/div[2]/div/span/span/input").send_keys("04")
