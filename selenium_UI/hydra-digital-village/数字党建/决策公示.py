...
driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[7]/div[2]/a[4]").click()
#线上
#driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[13]").click()
#element = driver.find_element_by_xpath("//*[@id='root']/div/div/div[1]/div[1]/div/div[1]/div[13]/div[2]/a[4]")
...
time.sleep(1)
driver.find_element_by_xpath("/html/body/div[4]/div/div/div/div[2]/table[@class='el-year-table']/tbody/tr[1]/td[3]/a").click()
driver.find_element_by_xpath("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/form/div[4]/div/div/input").send_keys("测试决策公示")
...
#c查看
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[5]/div/div/a[1]").click()
time.sleep(2)
capture(driver,filephoto="D:/" + str(time.time())+".png")
driver.find_element_by_xpath("/html/body/div[4]/div/div[2]/div/div[2]/button").click()
#编辑
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[5]/div/div/a[2]").click()
time.sleep(2)
...
driver.refresh()
#删除
driver.find_element_by_xpath("//*[@id='root']/div/div/div[3]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div[2]/table/tbody/tr/td[5]/div/div/a[3]").click()
capture(driver,filephoto="D:/" + str(time.time())+".png")
