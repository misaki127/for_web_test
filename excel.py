...
if __name__ == '__main__':
    ...
    for i in range(0,len(row_list1)):
        sheet1.write(0,i,row_list1[i],set_style('Times New Roman',220,True))
    ...
    for i in range(0,len(row_list2)):
        sheet1.write(2,i,row_list2[i],set_style('Times New Roman',220,True))

    a = int(input("请输入需要新增的户主数量：\n"))
    b = int(input("请输入需要新增的家庭成员数量：\n"))
    event_list = [a,b]
    list1 = []
    village_id='1302020001'
    village_ext_id = 'CS1587114291811'
